...
ROUTES = [
    ...
    ("PATCH",r"/admin/users/(?P<id>[^/]+)/suspend",  _admin.suspend_user,  ["id"]),
    ("PATCH",r"/admin/users/(?P<id>[^/]+)/activate", _admin.activate_user, ["id"]),
    ...
    ("DELETE",r"/admin/categories/(?P<id>[^/]+)",                    _admin.delete_category,             ["id"]),
    ...
    ("DELETE",r"/admin/subscriptions/plans/(?P<id>[^/]+)",           _admin.delete_subscription_plan,    ["id"]),
